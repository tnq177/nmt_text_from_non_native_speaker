...
class Encoder(nn.Module):
    ...
    def __init__(self, num_layers, num_heads, embed_dim, ff_dim, dropout=0.):
        ...
        for i in range(num_layers):
            ...
            self.lnorms.append(nn.ModuleList([nn.LayerNorm(embed_dim, eps=1e-6) for i in range(2)]))
...
class Decoder(nn.Module):
    ...
    def __init__(self, num_layers, num_heads, embed_dim, ff_dim, dropout=0.):
        ...
        for i in range(num_layers):
            ...
            self.pos_ffs.append(PositionWiseFeedForward(embed_dim, ff_dim, dropout=dropout))
            self.lnorms.append(nn.ModuleList([nn.LayerNorm(embed_dim, eps=1e-6) for i in range(3)]))
